...
class ResNet(nn.Module):
    ...
    def get_pretrained_weights_(self, prefix='extract', ignore='fc'):
        """Utilize pytorch model zoo in the following steps:
        1. Load pretrained model from url
        2. Take only the feature extraction weights
        3. Add necessary prefix to keys to fit to customized model
        """
